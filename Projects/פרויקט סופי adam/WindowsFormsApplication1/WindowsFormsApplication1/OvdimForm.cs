...
{
    public partial class OvdimForm : Form
    {
      private OleDbConnection con = new OleDbConnection(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\Comp-19\Desktop\פרויקט סופי adam\Hospital.mdb");
        HospitalDataSet.OvdimDataTable dt;
        ...
        public OvdimForm(Button btnClicked, string Zhot)
        {
            InitializeComponent(); zh=Zhot;
            btn = btnClicked;
            dt = hospitalDataSet.Ovdim;
            
            textBoxsArray = new TextBox[] { txtZhot, txtShem, txtMishpaha, txtBirthday, txtGil, txtGender, txtKtovet, txtCity, txtTafkid, txtTelephone, txtEmail, txtMaskort};
            hintsArray = new Label[] { hintZhot, hintShem, hintMishpaha, hintBirthday, hintGil, hintGender, hintKtovet, hintCity, hintTafkid, hintTelephone, hintEmail, hintMaskort};
            labelsArray = new Label[] { lblZhot, lblShem, lblMishpaha, lblBirthday, lblGil, lblGender, lblKtovet, lblCity, lblTafkid, lblTelephone, lblEmail, lblMaskort};
        }


        //                  בפתיחת הפורם
        private void OvdimForm_Load(object sender, EventArgs e)
        {
            ...
            OvdimForm_SizeChanged(sender, e);
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e) // כפתור ההוספה
        {
            ...
            else
            {
                ...
                {
                    if (textBoxsArray[i].Text == "" && i != 3 && i != 4 && i!=9)
                    {
                        string s = "";
                ...
                if (txtBirthday.Text != "")
                {
                    if (int.Parse(txtGil.Text) < 18 || int.Parse(txtGil.Text) > 90)
                    {
                        hintGil.Text = "גילאים 90 - 18";
        ...
        //              כשהפורם משנה גודל
        private void OvdimForm_SizeChanged(object sender, EventArgs e)
        {
